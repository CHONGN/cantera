...
protected:
    ...
    double m_Tfuel;         // fixed temperature at fuel side
    size_t m_Tfuel_j;              // fixed temperature location at fuel side
    double m_Toxid;         // fixed temperature at oxidizer side
    size_t m_Toxid_j;              // fixed temperature location at oxidizer side
